    ...
    <div className="bg-white min-h-screen py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {serviceList.map((service, index) => (
            <div
              ...
              className="relative group h-[400px] rounded-[2rem] overflow-hidden transition-all duration-500 transform hover:-translate-y-2 shadow-lg"
            >
              {/* Overlay */}
              <div 
              ...
              <div className="relative flex flex-col h-full p-8 text-white">
                {/* Icon Circle */}
                <div 
                  className={`flex items-center justify-center size-12 rounded-full mb-6 ${
                    service.highlight 
                      ? "bg-white text-[#FF7D44]" 
                ...
                <div className="mt-auto">
                  ...
                  <p 
                    className={`text-sm leading-relaxed ${
                      service.highlight ? "text-white/95" : "text-gray-200"
                    }`}
                  >
                    {service.description}
                  </p>
        ...
        <div className="mt-20 text-center">
          <div className="inline-flex items-center space-x-2 text-gray-900 font-bold text-xl cursor-pointer hover:text-[#FF7D44] transition-colors">
