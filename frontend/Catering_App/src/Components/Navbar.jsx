...
function Navbar() {
  ...
  return (
    ...
    <div className="navbar bg-base-100 shadow-sm fixed z-50">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            <Link
              to={"/"}
              className={`cursor-pointer text-[20px] pb-[5px] scale-100 transition-all duration-700 ease-in text-dark border-b-2 border-transparent hover:border-b-orange-500 hover:text-orange-500 hover:-translate-y-0.5  ${
      ...
      <img
        src="/Feastify.png"
        className="h-11 m-3 block lg:hidden"
        alt="logo"
      />
    </div>
  );
